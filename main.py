...
def main():
    ...
    # print(args.t)
    # print(args.num_rounds)
    # print(args.eval_every)
    # print(args.clients_per_round)
    # print(args.lr)
    ...
    # print(client_model.num_classes)

    # Create server
    server = Server(client_model)
    # print(server.client_model)
    # print(server.model)
    # print(server.selected_clients)
    # print(server.updates)

    # print(args.use_val_set) False
    
    # Create clients
    clients = setup_clients(args.dataset, client_model, args.use_val_set)
    client_ids, client_groups, client_num_samples = server.get_clients_info(clients)
    print('Clients in Total: %d' % len(clients))
    # print('List of Client_ids', client_ids)
    # print('number of samples', client_num_samples)
    # print('client_groups', client_groups)
    
    # Initial status
    print('--- Random Initialization ---')
    stat_writer_fn = get_stat_writer_function(client_ids, client_groups, client_num_samples, args)
    # print(stat_writer_fn)
...
def get_stat_writer_function(ids, groups, num_samples, args):
    ...
    # print(args.metrics_name) metrics
